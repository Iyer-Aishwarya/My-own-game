...
function setup() {
  ...
  player = createSprite(displayWidth-1300, displayHeight-500, 50, 50);
...
if(keyWentDown("space")){
  bullet = createSprite(displayWidth-1200,player.y-3,20,10)
...
function enemy(){
  if(frameCount%40===0){
    asteroid = createSprite(random(500,1000),random(100,500),40,40)
